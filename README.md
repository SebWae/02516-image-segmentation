...
To setup the virtual environment used when submitting a batch job, follow the instructions in [HPC Instructions](https://github.com/SebWae/02516-video-classification/blob/main/docs/hpc_instructions.md). Once the virtual environment (`venv_proj3`) has been created, install the required packages specified in `requirements.txt` by running: 
```
